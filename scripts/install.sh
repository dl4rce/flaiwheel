...
# ══════════════════════════════════════════════════════
#  PHASE 7e: Install Claude Cowork skill (skills/flaiwheel/SKILL.md)
# ══════════════════════════════════════════════════════

_phase7e_claude_skills() {
SKILLS_DIR="${PROJECT_DIR}/.skills/skills/flaiwheel"

if [ -f "${SKILLS_DIR}/SKILL.md" ]; then
    ok "Claude Cowork skill already installed at .skills/skills/flaiwheel/SKILL.md"
    return 0
fi
...
ok "Installed Claude Cowork skill → .skills/skills/flaiwheel/SKILL.md"
} # end _phase7e_claude_skills
...
_phase7e_claude_skills & _PIDS+=($!) _PJOBS+=("claude-skills")
