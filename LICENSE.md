...
- **(b)** Your use is by an **organization with no more than 10 individuals** (employees, contractors, or other persons using the Licensed Work on behalf of the organization), or
- **(c)** You are a participant in the **Flaiwheel Beta Program** (sign-up at [flaiwheel.app](https://flaiwheel.app/#beta) before 2027-01-01), in which case you may use the Licensed Work commercially through **2026-12-31** regardless of organization size. This grant is time-boxed and does not extend beyond the stated date.

Use beyond these limits (e.g., commercial use by organizations with more than 10 individuals after the Beta period, or production licensing for teams of 11+) requires a commercial license from the Licensor.
...
**For commercial licensing inquiries: [info@4rce.com](mailto:info@4rce.com)**
